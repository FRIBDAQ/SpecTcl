//  CMSpectrum2DB.h:
//
//    This file defines the CMSpectrum2DB class.
//
// Author:
//    Jason Venema
//    NSCL
...
#ifndef __MSPECTRUM2DB_H  //Required for current class
#define __MSPECTRUM2DB_H
                               //Required for base classes
#ifndef __SPECTRUM2DB_H
...
class CMSpectrum2DB  : public CSpectrum2DB
{
...
public:
  ...
  // Destructor
  virtual  ~CMSpectrum2DB( ) { }

private:

  //Copy constructor [illegal]
  CMSpectrum2DB(const CMSpectrum2DB& acspectrum1dl); 

  //Operator= Assignment Operator [illegal] 
  CMSpectrum2DB operator= (const CMSpectrum2DB& aCSpectrum1D);

  //Operator== Equality Operator [Not too useful but:]
 public:

  int operator== (const CMSpectrum2DB& aCMSpectrum)
  { return (
	    (CSpectrum2DB::operator== (aCMSpectrum)) &&
