...
"CTestFile.cpp: Copyright 1999 NSCL, All rights reserved\n";
...
//
Int_t 
CTestFile::Read(Address_t pBuffer, UInt_t nSize)
{
...
//
Int_t 
CTestFile::Write(const Address_t pBuffer, UInt_t nBytes)
{
...
//
void 
CTestFile::Open(const std::string& rsFilename, UInt_t nAccess) 
{
...
//
UInt_t 
CTestFile::GetDistributionCount() const 
{
...
//
void 
CTestFile::AddDistribution(CDistribution& rDistribution) 
{
...
//
void 
CTestFile::ClearDistribution(UInt_t nDistribution) 
{
...
//
void
CTestFile::DoAssign(const CTestFile& arhs)
{
...
//    Utility.
UInt_t 
CTestFile::FormatNSCLHeader(Address_t pBuffer)
{
...
///   Utility
UInt_t
CTestFile::FormatEvent(Address_t pBuffer)
{
...
//
void
CTestFile::SetEventCount(Address_t pBuffer, UInt_t nEvents)
{
...
//    Utility function.
void
CTestFile::SetBufferSize(Address_t pBuffer, UInt_t nBytes)
{
