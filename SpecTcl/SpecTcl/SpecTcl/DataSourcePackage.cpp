...
//
int 
CDataSourcePackage::AttachFileSource(CTCLResult& rResult) 
{
...
//
int 
CDataSourcePackage::AttachTapeSource(CTCLResult& rResult, const char* pDevice) 
{
...
//
int 
CDataSourcePackage::AttachPipeSource(CTCLResult& rResult) 
{
...
//
int 
CDataSourcePackage::OpenSource(CTCLResult& rResult, 
...
//
int 
CDataSourcePackage::CloseSource(CTCLResult& rResult) 
{
...
//
int 
CDataSourcePackage::OpenNextTapeFile(CTCLResult& rResult) 
{
...
//
int 
CDataSourcePackage::RewindTape(CTCLResult& rResult) 
{
