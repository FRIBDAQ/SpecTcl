...
CCFLAGS= /define=('MOTIF_DEFINESCC',FLEXV2)/diagnostics-
/include=(sys$disk:[],dataq:[gnu.gcc.gxx_include])/extern=common-
/prefix=all/nowarn/share/debug/noopt

XCCFLAGS= /debug/noopt/DEFINE=('MOTIF_DEFINES',FLEXV2)/diagnostics-
...
.FIRST
	...
	MOTIF_DEFINES== "VMS,__STDC__,XTFUNCPROTO,""vms"",""globalref=extern"",""externalref=extern"""
	MOTIF_DEFINESCC== "XTFUNCPROTO,VMS"
...
INSTALL : SYSTEM
	echo "VMS INSTALLATION NOT YET AUTOMATED Sorry"
...
windfile_lex.OBJ : windfile.l dispwind.h superpos.h windfile_lex.h windio.h
	$(LEX) windfile.l
	EDIT/TPU/COMMAND=WIN.TPU/OUTPUT=WINDFILE_LEX.CC  $(LEXOUT)/NODISPLAY
...
Xamine.exe : Xamine.OBJ,\
	...
	spccompatchoice,spclimchoice,ptlist,\
	lexsupport, gc, gcmgr, xaminegc, \
	XWINDOWS.opt/opt
...
winiomenu.OBJ : winiomenu.cc XMDialogs.h helpmenu.h winiomenu.h panemgr.h \
	...
	errormsg.h buttonsetup.h menusetup.h \
	XMCallback.cc XMCallback.h
...
XMShell.OBJ : XMShell.cc XMShell.h XMCallback.h
