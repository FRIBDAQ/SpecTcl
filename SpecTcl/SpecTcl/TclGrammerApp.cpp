...
/*
  Change Log:
  $Log$
  Revision 4.16.2.2  2007/04/02 15:46:45  ron-fox
  Final commit prior to April shutdown distrobuild

  Revision 4.16.2.1  2006/11/09 20:53:54  ron-fox
  Install the CHANGLOG
...
int CTclGrammerApp::operator()() {
  ...
  // Finally runthe version script:

  try {
    gpInterpreter->GlobalEval(printVersionScript);
  }
  catch (...) {
    cerr << "This is SpecTcl version " << gpVersion << endl;
  }
