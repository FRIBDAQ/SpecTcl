...
// Create A1900 unpacker (see a1900Unpacker.cpp)
static CA1900Unpacker UnpackA1900;
// Create A1900 calibrator (see a1900Calibrator.cpp)
static CA1900Calibrator CalibrateA1900;
...
void 
CA1900SpecTcl::CreateAnalysisPipeline(CAnalyzer& rAnalyzer)  
{ 
  RegisterEventProcessor(UnpackA1900);
  RegisterEventProcessor(CalibrateA1900);
...
// Functions for class CA1900SpecTcl
...
*/
void 
CA1900SpecTcl::BindTCLVariables(CTCLInterpreter& rInterp)  
{ 
...
*/
void 
CA1900SpecTcl::SourceLimitScripts(CTCLInterpreter& rInterpreter)  
...
*/
void 
CA1900SpecTcl::CreateHistogrammer()  
...
*/
void 
CA1900SpecTcl::SelectDisplayer(UInt_t nDisplaySize, CHistogrammer& rHistogrammer)  
...
*/
void 
CA1900SpecTcl::SetupTestDataSource()  
...
*/
void 
CA1900SpecTcl::CreateAnalyzer(CEventSink* pSink)  
...
*/
void 
CA1900SpecTcl::SelectDecoder(CAnalyzer& rAnalyzer)  
...
*/
void 
CA1900SpecTcl::AddCommands(CTCLInterpreter& rInterp)  
{ 
...
*/
void 
CA1900SpecTcl::SourceFunctionalScripts(CTCLInterpreter& rInterp)  
