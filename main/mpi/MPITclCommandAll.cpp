...
*/
CMPITclCommandAll::CMPITclCommandAll(CTCLInterpreter& interp, const char* command, CTCLObjectProcessor* pActual) :
 ...
 * destructor
*/
CMPITclCommandAll::~CMPITclCommandAll() {
...
*/
int
CMPITclCommandAll::operator()(CTCLInterpreter& interp, std::vector<CTCLObject>& objv) {
