...
/** Implementatio of the CMPITclCommand class */
 ...
 * created using **new**.
*/
CMPITclCommand::CMPITclCommand(CTCLInterpreter& interp, const char* command, CTCLObjectProcessor* pActual) :
