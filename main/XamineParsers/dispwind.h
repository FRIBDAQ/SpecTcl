...
#ifndef DISPWIND_H_INSTALLED
#define DISPWIND_H_INSTALLED
...
public:
    ...
    int ismapped() { return user_mapping; }
    void setmapped(int m) { user_mapping = m; }
    void unmap() { user_mapping = FALSE; }
...
public:
    ...
    /*! \brief pass a reference toa spectrum interface
     */
};
#endif
