...
#ifndef TWODIMGATEEDIT_H
#define TWODIMGATEEDIT_H
 ...
 *
 */
class TwoDimGateEdit : public QWidget
{
    Q_OBJECT
...
public:
     ...
     */
    explicit TwoDimGateEdit(QRootCanvas& viewer,
...
private:
    ...
    void registerGate(GGate* pGate);
    void editGate(GGate* pGate);
