...
C
C
	INTEGER XAMINE_ISMAX, XAMINE_WORDS, XAMINE_LONGS, XAMINE_PAGES
...
C	PARAMETER (XAMINE_SPECBYTES=1048576*8)
	...
	PARAMETER (XAMINE_PAGES=(XAMINE_SPECBYTES+511)/512)
C
...
C
	DIMENSION XAMINE_DATA1(XAMINE_PAGES*512)
