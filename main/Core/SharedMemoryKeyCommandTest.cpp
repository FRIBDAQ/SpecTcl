...
class CSharedMemoryKeyCommandTests : public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE(CSharedMemoryKeyCommandTests);
...
CPPUNIT_TEST_SUITE_REGISTRATION(CSharedMemoryKeyCommandTests);
