...
void TreeVectorTests::iter_1() {
    // initially, begin == end.

    ASSERT(CTreeParameterVector::begin() == CTreeParameterVector::end());
}
void TreeVectorTests::iter_2() {
    // When there are vetors we'll have the correct # of iterztions
