...
#ifndef __SPECTRUM2DB_H  //Required for current class
#define __SPECTRUM2DB_H
...
private:
  ...
  CSpectrum2DB(const CSpectrum2DB& acspectrum1dl); 

			//Operator= Assignment Operator [illegal] 

  CSpectrum2DB operator= (const CSpectrum2DB& aCSpectrum1D);

			//Operator== Equality Operator [Not too useful but:]
public:
  int operator== (const CSpectrum2DB& aCSpectrum)
  { return (
