...
private:
  ...
  CSummarySpectrumL(const CSummarySpectrumL& acspectrum1dl); 

			//Operator= Assignment Operator [illegal] 

  CSummarySpectrumL operator= (const CSummarySpectrumL& aCSpectrum1D);

			//Operator== Equality Operator [Not too useful but:]
public:
  int operator== (const CSummarySpectrumL& aCSpectrum)
  { return (
