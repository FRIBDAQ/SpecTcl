...
class Menu(QWidget):
        ...
        def create_menuBox(self):
                ...
                self.applyGate = QPushButton("Apply Gate", self)
                self.sumRegion = QPushButton("Summing Region", self)
                self.intRegion = QPushButton("Integrate", self)                
                ...
                layout.addWidget(self.applyGate)
                layout.addWidget(self.regionList)
                self.regionList.setFixedWidth(150)                
                layout.addWidget(self.sumRegion)
                layout.addWidget(self.intRegion)
                layout.addStretch(1)
